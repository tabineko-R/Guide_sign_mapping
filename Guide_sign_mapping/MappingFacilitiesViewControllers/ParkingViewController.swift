...
class ParkingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        switch number {
        case 1:
            buttonNode = buttonNode?.childNode(withName: "P_1", recursively: false)
        case 2:
            buttonNode = buttonNode?.childNode(withName: "P_2", recursively: false)
        case 3:
            buttonNode = buttonNode?.childNode(withName: "P_3", recursively: false)
        default:
            break
        }
...
extension ParkingViewController: ARSCNViewDelegate {
